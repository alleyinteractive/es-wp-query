...
if ( defined( 'ES_WP_QUERY_TEST_ENV' ) && ES_WP_QUERY_TEST_ENV ) {
	...
	add_filter(
		...
		function() {
			return array(
				'numeric_value'    => array( 'raw', 'long', 'double' ),
				'decimal_value'    => array( 'raw', 'value', 'long', 'double' ),
				'time'             => array( 'raw', 'value', 'long' ),
				'foo'              => array( 'raw', 'value', 'long' ),
				'foo2'             => array( 'raw', 'value' ),
				'foo3'             => array( 'raw', 'value' ),
				'foo4'             => array( 'raw', 'value' ),
				'number_of_colors' => array( 'raw', 'value', 'long' ),
				'oof'              => array( 'raw', 'value' ),
				'bar'              => array( 'raw', 'value' ),
				'bar1'             => array( 'raw', 'value' ),
				'bar2'             => array( 'raw', 'value' ),
				'baz'              => array( 'raw', 'value' ),
				'froo'             => array( 'raw', 'value' ),
				'tango'            => array( 'raw', 'value' ),
				'color'            => array( 'raw', 'value' ),
				'vegetable'        => array( 'raw', 'value' ),
				'city'             => array( 'raw', 'value' ),
				'address'          => array( 'raw', 'value' ),
			);
		}
	);
